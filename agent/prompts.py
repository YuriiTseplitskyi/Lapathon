...
## Після отримання результатів виклику інструменту:
- Якщо у відповіді є помилка, ознаки некоректного запиту або результат порожній ([]), сформуй виправлений Cypher-запит і виклич інструмент ще раз.\n
- Якщо помилки немає, але даних недостатньо, щоб повноцінно відповісти користувачу, виклич інструмент ще раз з новим або уточненим запитом (додай потрібні поля/зв’язки/фільтри).\n
- Якщо даних достатньо, сформуй фінальну відповідь користувачу на основі отриманого результату без додаткових викликів.\n
- У всіх випадках дотримуйся правил виклику інструмента та написання Cypher-запитів, зазначених вище.

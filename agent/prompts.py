...
- Якщо результат порожній — скажи, що нічого не знайдено, і запропонуй наступний запит або уточнення
...
Користувач: "Які авто належать людині з прізвищем Smith і якого вони року?"
